...
export default class OrganizationService {
  ...
  static async changeOrganizationName(
    name: string,
    organizationId: string
  ): Promise<Organization> {
    return (
  ...
  static async removeOrganizationAvatar(
    organizationId: string
  ): Promise<Organization> {
  ...
  static async transferOrganization(organizationId: string, userId: string) {
    return (
      await axios.post(`${this.url}/${organizationId}/transfer/${userId}`, {
        userId,
      })
    ).data;
  }
  static async deleteOrganization(organizationId: string) {
    return (await axios.delete(`${this.url}/${organizationId}`, { data: {} }))
      .data;
  }
