...
import { NotificationFilter, Notification } from '@/features/auth/Notifications';
...
export default function OrganizationNotifications() {
	...
	const { notifications, getNotifications, notificationLastFetchedPage } = useOrganizationStore();
				...
				{isFetching ? (
					...
					<div className='scroll p-6 divide-y-2' id='scrollableDiv'>
						{!_.isEmpty(notifications) ? (
							...
							<EmptyState title={t('version.noNotifications')} type='app' />
						)}
					</div>
				)}
			</div>
